...
export function getSolitaireContent() {
...
export class SolitaireApp extends BaseApp {
  getWindowContent() {
    return getSolitaireContent(this.initData, this.services);
  }

  mount() {
    return initSolitaire(this.windowEl, this.initData, this.services.windowManager, this.services, this);
  }
}
